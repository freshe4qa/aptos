...
echo "=================================================="
echo -e "\e[1m\e[32mAptos Success \e[0m"
echo -e "Backup key files \e[1m\e[32mprivate-keys.yaml, validator-identity.yaml, validator-full-node-identity.yaml \e[0mlocated in: \e[1m\e[32m~/$WORKSPACE\e[0m"
echo "=================================================="
